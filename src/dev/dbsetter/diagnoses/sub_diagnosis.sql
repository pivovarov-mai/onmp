CREATE TABLE IF NOT EXISTS "sub_diagnosis" (
  ...
  "recommendations_sub_diagnosis" TEXT NOT NULL
);
...
COMMENT ON COLUMN public."sub_diagnosis".recommendations_sub_diagnosis IS 'Рекомендации поддиагноза';

INSERT INTO "sub_diagnosis" ("id", "name_sub_diagnosis", "recommendations_sub_diagnosis") VALUES
