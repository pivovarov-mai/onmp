...
INSERT INTO "gastric_lavage_in_children" ("age", "one_time_volume", "maximum_flushing_volume") VALUES
  ...
  ('1-2 месяца', '60-90', '200-250'),
  ('3-4 месяца', '90-100', '300-400'),
  ('5-6 месяцев', '100-110', '400-500'),
  ('7-8 месяцев', '110-120', '600-700'),
  ('9-12 месяцев', '120-150', '800-900'),
  ('2-3 года', '200-250', '1-1,5 л'),
  ('4-5 лет', '300-350', '1,5-2 л'),
  ('6-7 лет', '350-400', '2,5-3 л'),
  ('8-11 лет', '400-450', '3,5-4 л'),
