...
INSERT INTO "acute_respiratory_failure" ("id", "state", "consciousness", "skin", "arterial_pressure", "heart_rate", "respiratory_rate", "spo2") VALUES
  ('1', 'Норма', 'Ясное', 'Обычной окраски', 'Норма', 'Норма', '12-16', '96-99'),
  ('2', 'ОДН I', 'Ясное', 'Бледность, умеренный цианоз', 'Норма, умеренная гипертензия', ' 100-110', '14-20', '92-95'),
  ('3', 'ОДН II', 'Возможно возбуждение, агрессивность', 'Цианоз', 'Умеренная гипертензия', '110-120', '20-30', '90-92'),
  ('4', 'ОДН III', 'Спутанность, оглушение', 'Выраженный цианоз', 'ГИПЕРтензия', '120-140', '30-40', '85-90'),
  ('5', 'ОДН IV', 'Гипоксическая кома, судороги, мидриаз', 'Мраморный цианоз', 'ГИПОтензия', '> 140 или < 60, возможна аритмия', '> 40 или < 8', '85');