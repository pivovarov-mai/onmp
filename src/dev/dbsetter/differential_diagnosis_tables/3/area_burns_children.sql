...
INSERT INTO "area_burns_children" ("id", "area_affected", "zero_years", "one_year", "five_years", "ten_years", "fifteen_years") VALUES
  ...
  ('14', 'Левая ягодица', '2.5', '2.5', '2.5', '2.5', '2.5'),
  ('15', 'Правая ягодица', '2.5', '2.5', '2.5', '2.5', '2.5'),
  ('16', 'Половина бедра', '2.75', '3.25', '4', '4.5', '4.75'),
  ('17', 'Половина голени', '2.25', '2.5', '2.75', '3', '3.25'),
  ('18', 'Тыльная поверхность стопы', '1.25', '1.25', '1.25', '1.25', '1.25'),
  ('19', 'Подошвенная поверхность стопы', '1.25', '1.25', '1.25', '1.25', '1.25');