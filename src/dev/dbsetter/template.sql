...
COMMENT ON COLUMN public."template".account_user_id IS 'Внешний ключ к таблице account_user(id) - ID пользователя(врача)';
...
COMMENT ON COLUMN public."template".scarif IS 'Скариф';
