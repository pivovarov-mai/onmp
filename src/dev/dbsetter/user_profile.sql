...
COMMENT ON COLUMN public."user_profile".account_user_id IS 'Внешний ключ к таблице account_user на бэке';

INSERT INTO "user_profile" ("last_name", "first_name", "middle_name", "date_of_birth", "phone_number", "passport", "account_user_id") VALUES
