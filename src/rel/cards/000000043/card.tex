...
\addtext{на затруднение прохождения пищи по пищеводу, беспокоит около 4 часов, после нарушения диеты (прием в пищу твердого- кусок мяса), самостоятельно не лечилась, вызвала СМП, после проведенной терапии отмечает улучшение, однако сохраняется боязнь еды и питья}
\addtext{В анамнезе:в течении всей жизни страдае ахалазией пищевода, также все женские родственники старшего поколения и дочь, пищу принимает в кашецеобраной форме, наблюдается рядом хирургов и гастроэнтерологов.Травмы, операции отрицает. Аллергии не было. Менопауза с 50 лет. Эпиданамнез не отягощен, на самоизоляции, сезонные прививки отрицает. ЕМИАС, МГФОМС не доступен}
\addtext{ср.тяжести}
\addtext{ясное}
\addtext{15}
\addtext{активное}
...
\addtext{нет}
\addtext{влажный}
\addtext{обложен беловатым налетом у корня языка}
\addtext{правильная}
\addtext{мягкий}
\addtext{не напряжен}
...
\addtext{нет}
\addtext{нет}
\addtext{ выполняет правильно, в позе Ромберга устойчив}
\addtext{ дизурии нет}
\addtext{ отрицательный с обеих сторон}
\addtext{Вес=55кг, Рост=162см, ИМТ=21, Пониженного питания, тургор сохранен}
\addtext{SpO2 98\%;  ЭКГ(24.02.21 02:20) Ритм синусовый, правильный с ЧСС 65 в мин, ЭОС отклонена влево, ST- изолиния. Данных за острую коронарную патологию нет. ЭКГ для оценки динамики - не предоставлено}
\addtext{расспрос, физические методы охлаждения{\par}в присутствии бр. самостоятельно приняла разведенную таблетку дюспаталин 135 мг, через 10 мин рвота содержимым. Sol.Metoclopramidi 5mg/ml-2ml в/м в левую ягодичную область, Sol.Drotaverini 20mg/ml-2ml в/м в правую ягодичную область{\par}Отказ от вызова бригады СМП, актив в поликлинику{\par}{\par}Через 52 мин: состояние средней степени тяжести, восстановлена проходимость для жидкостей, АД 120/70 мм.рт.ст., ЧСС64 в мин, пульс 65 в мин, ЧД 16 в мин.}
\addtext{консультация гастроэнтеролога}
\addtext{ нет}
\addtext{10}
\addtext{1}
\addtext{1}
