...
\addtext{повышение температуры до 39,5, редкий кашель, недомогание, заолела остро, с 04.01.21, 07.01.21 проведено КТ, поставлен диагноз Вирусная полисигментарная двухсторонняя пневмония, КТ 1, лечение получает, одышку, чувство нехватки воздуха отрицает. В семье все болеют или выздоравливают после коронавирусной инфекции, сезонные прививки отрицает. за пределы Москвы не выезжали более года. }
\addtext{Хронические заболевания, травмы, операции отрицает. Гинекологический анамнез без особенностей.Аллергию отрицает.
ЕМИАС,МГФОМС не информативен}
\addtext{ср.тяжести}
\addtext{ясное}
\addtext{15}
\addtext{активное}
...
\addtext{Вес=100кг, Рост=164см, ИМТ=37, NEWS- 0 баллов}
\addtext{SpO2 95\%;  ЭКГ(09.01.21. 10:31) синусовая тахикардия с ЧСС 94 в мин ЭОС не отклонена,ST- изолиния.Данных за острую коронарную патологию нет}
\addtext{ расспрос, изучение мед. документов,  физические методы охлаждения{\par} Tab.Paracetamoli 500mg внутрь{\par}Отказ от вызова бригады СМП, актив в поликлинику{\par}{\par} через 33 мин: состояние удовлетворительное, АД 120/ 80 мм.рт.ст., ЧСС 88 в мин, пульс 88 в мин, ЧД 16 в мин, температура 37,5, NEWS 0 баллов}
\addtext{продолжить назначенное лечение}
\addtext{ нет}
\addtext{2}
\addtext{1}
\addtext{1}
...
\addtext{2}
\addtext{}
\addtext{костюм защитный. респиратор, маска, очки- аа 1 шт}
\addtext{09.01.21}
\addtext{101770726}
\begin{document}
\relsize{-2}
