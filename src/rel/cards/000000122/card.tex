...
\addtext{}
\addtext{}
\addtext{Код от домофона не действителен, на неоднократный прозвон адреса не отвечает, после открытия подъездной дверипосторонним человеком, в указанной квартире данный человек не проживает. Доложено  диспетчеру города 223, ст. врач Цибизова{\par}{\par}Отказ от вызова бригады СМП, актив в поликлинику{\par}{\par}}
\addtext{}
\addtext{}
\addtext{0}
\addtext{0}
