...
\addtext{На недомогание, головокружение, двигаются предметы по часовой стрелке, тошноту, двухкратную рвоту - водой. Жалобы беспокоят с 10:00 11.02.21г., самостоятельно не лечилась}
\addtext{Со слов страдает: бронхиальной астмой, аутоиммунный тиреоидит, фиброзно- кистозная мастопатия- оперирована 2004 год, аппендэктомия в 17 лет, овариэктомия справа 91 г. Травмы отриуает. Эпиданамнез не отягощен, за пределы РФ и Москвы не выезжала более 5 лет, сезонные прививки- сент 2020 г. - пневмококк. Аллергию отрицает
...
\addtext{обычные}
\addtext{ живая}
\addtext{ крупноразмашистый влево и вправо}
\addtext{ нет}
\addtext{}
\addtext{нет}
\addtext{нет}
\addtext{пальценосовая  проба- мимопопадание с обеих рук}
\addtext{ дизурии нет}
\addtext{ отрицательный с обеих сторон}
\addtext{Вес=90кг, Рост=168см, ИМТ=32, Светобоязнь}
\addtext{сахар крови: 7.4 ммоль/л; SpO2 98\%;  ЭКГ(11.02.21г. 12:19) ритм синусовый, правильный с ЧСС 67 в мин, ЭОС- отклонена влево. ST- изолиния. ЭКГ признаки ГЛЖ, диффузные изменения по нижней стенке. ЭКГ для анализа не предоставлено. Данных за острую коронарную патологию нет.}
\addtext{ расспрос;{\par} Tab. Glicini 500mg, сублингвально{\par}Вызов бригады СМП{\par}{\par}Больная передана бригаде СМП  в состоянии средней степени тяжести, АД 110/70 мм.рт.ст., ЧСС 67 в мин, пульс 67 в мин, ЧД 16 в мин}
\addtext{}
\addtext{ нет}
\addtext{4}
\addtext{1}
