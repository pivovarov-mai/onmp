...
\addtext{на боль в подколенной ямке постоянного характера, усиливается при ходьбе, пройдя 5 шагов останавливается. Жалобы появились 2 дня назад, усилились, лечилась мазями НПВС - без эффекта, за медпомощью не обращалась, зябкость в ногах появилась несколько дней назад.}
\addtext{В анамнезе : варикозное расширение вен нидних конечностей- не обследована, хронический колит- ремиссия, хр.  пиелонефрит, ремиссия, другие хронические заболевания отрицает, травмы- отрицает, операции- 2011г.-экстирпация матки. Аллергию отрицает. Эпиданамнез не отягощен, за пределы Москвы и РФ не выезжала, сезонные прививки отрицает.
ЕМИАС,МГФОМС: I11.9 M 42.1}
\addtext{ср.тяжести}
\addtext{ясное}
\addtext{15}
\addtext{активное}
\addtext{Щадит левую ногу}
\addtext{сухие}
\addtext{}
...
\addtext{ не увеличены}
\addtext{ нет}
\addtext{пастозность голеней D=S}
\addtext{36.6}
\addtext{16}
\addtext{}
\addtext{нет}
...
\addtext{Вес=92кг, Рост=152см, ИМТ=40, Визуально левая нога бледновата, варикозно расширенные  подкожные вены, на ощупь холодная, пульс на внутренней малоберцовой артерии левой ноги ослаблен по сравнению с правой. ВАШ 30\% }
\addtext{SpO2 98\%;  ЭКГ(11.02.21г.14:41) ритм синусовый, правильный с ЧСС 88 в мин, ЭОС- отклонена влево. ST- изолиния. Данных за острую коронарную патологию нет}
\addtext{ расспрос; изучение мед. документов{\par}Установлен в/в катетер,  Sol.Ketaroli 30mg/ml-1ml  в/м в правую ягодичную область;  Tab.Acidi acetylsalicylici 500 mg разжевать, внутрь{\par}Вызов бригады СМП{\par}{\par}Больная передана в состоянии средней степени тяжести, АД 130/80 мм.рт.ст., ЧСС 88 в мин, пульс 88 в мин, ЧД 16 в мин, ВАШ 30 \%}
\addtext{}
\addtext{ нет}
\addtext{6}
\addtext{1}
