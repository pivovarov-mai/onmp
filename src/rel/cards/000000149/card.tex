...
\addtext{На недомогание, подъем температуры до 37,3, заболел остро, болен первый день, связывает с переохлаждением, самостоятельно не лечился, за мед помощью не обращался}
\addtext{Эпид анамнез: контакт с ковид 19 отрицает, из Москвы не выезжал, сезонные прививки отрицает. В анамнезе: травмы, операции отрицает, аллергии нет. ЕМИАС, МГФОМС - S62.30(от 03.02.20), B18.2}
\addtext{удовл.}
\addtext{ясное}
\addtext{15}
\addtext{активное}
...
\addtext{Вес=90кг, Рост=180см, ИМТ=28, NEWS 0 баллов, зев гиперемирован, чистый, миндалины рыхлые, единичные гнойные пробки справа, регионарные лимфоузлы не увеличены, безболезненные, не спаяны между собой и окружающей клетчаткой}
\addtext{SpO2 98\%}
\addtext{ расспрос{\par}{\par}Оставлен на месте, актив в поликлинику{\par}{\par}Через 31мин: состояние удовлетворительное, АД 130/80 мм.рт.ст. , ЧСС 92 в мин, пульс 92 в мин, ЧД 16 в мин, температура 37,3, NEWS 0 балла}
