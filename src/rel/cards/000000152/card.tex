...
\addtext{головную боль в височных областях, подъем АД до 190/100 мм.рт.ст., приняла капотен 25 мг, моксонидин 0,4 мг, со слов эффект недостаточный, ухудшение самочувствия около недели с плохо коррегируемой гипертонии, однако препараты базовой терапии принимает нерегулярно(валсартан)}
\addtext{В анамнезе, гипертоническая болезнь, сахарный диабет 2 типа (метформин), инсульты, инфаркты отрицает. Травм и операций не было. Менопауза с 51 года. Аллергию отрицает. Эпиданамнез не отягощен, за пределы Москвы не выезжала, сезонные прививки отрицает. ЕМИАС, МГФОМС - не доступен}
\addtext{удовл.}
\addtext{ясное}
\addtext{15}
\addtext{активное}
...
\addtext{Вес=95кг, Рост=162см, ИМТ=36}
\addtext{SpO2 98\%;  экг(16.02.21 17:30) ритм синусовый, правильный с ЧСС 72 в мин, ЭОС- отклонена влево.ST- изолиния.Данных за острую коронарную патологию нет}
\addtext{ расспрос,{\par} Tab.Moxonidini 0,4mg -сублингвально,  Sol.Ketaroli 30mg/ml-1ml  в/м в правую ягодичную область{\par}Оставлен на месте, рекомендовано обратиться в поликлинику{\par}{\par}Через 40 мин: состояние удовлетворительное, АД 150/70мм.рт.ст.,ЧСС 70 в мин, пульс 70 в мин, ЧД 16 в мин, жалоб нет }
