...
\addtext{Жалобы на боли в шее, напряжение мышц, ограничение в поворотах головы, беспокоят 2 день, связывает с переутомлением на работе, подобные жалобы регулярны}
\addtext{Со  слов страдает сколиозом, остеохондрозом. Радикулопатией шейного отдрла позвоночника. Травмы, операции отрицает. Аллергию отрицает.  Эпиданамнез не отягощен, из Москвы не выезжал более 3 лет, прививка от ковид 19, от 16.02.21г. ЕМИАС, МГФОМС- НЕ ИНФОРМАТИВЕН.}
\addtext{удовл.}
\addtext{ясное}
\addtext{15}
\addtext{активное}
...
\addtext{Нет}
\addtext{Нет}
\addtext{ в позе Ромберга устойчив, пальценосовая проба выполняет правильно, замедленно}
\addtext{ дизурии нет}
\addtext{ отрицательный с обеих сторон}
\addtext{Вес=60кг, Рост=178см, ИМТ=19, Визуально напряжение мышц шеи, некоторое уменьшение амплитуды поворота головы в обе стороны, ВАШ 30\%}
\addtext{SpO2 99\%}
\addtext{{\par} Sol.Ketaroli 30mg/ml-1ml в/м в правую ягодичную область{\par}Оставлен на месте, рекомендовано обратиться в поликлинику{\par}{\par}Через 26 мин: состояние удовлетворительное, АД 125/80 мм.рт.ст., ЧСС 80 в мин, пульс 80 в мин, ЧД 16 в мин, Ваш 10\%}
\addtext{Мази НПВС местно, ЛФК}
\addtext{ нет}
\addtext{6}
\addtext{1}
\addtext{1}
