...
\addtext{Больная жалуется на головную боль, головокружени, не уточняет, анамнез не дает}
\addtext{Со слов родственника около 21:30 16.02.21г. была обнаружена лежащей в рвотных массах (съеденным), на диване, с нарушенной речью, заговаривающейся, с повышением АД до 160/100 мм.рт.ст., ничего до приезда ОНМП не давали.Со слов дочери страдает гипертонией (амлодипин) и деменцией, стоит на учете у психиатра, травм и операций не было. Эпиданамнез без особенностей, за пределы Москвы и РФ не выезжала, сезонные прививки отрицает. Аллергию родственник отрицает. Менопауза с 50 лет. ЕМИАС, МГФОМС- не доступен}
\addtext{ср.тяжести}
\addtext{ясное}
\addtext{15}
\addtext{пассивное}
...
\addtext{аорте}
\addtext{влажный}
\addtext{чистый, отклонен вправо}
\addtext{правильная}
\addtext{мягкий}
\addtext{Не напряжен}
...
\addtext{обычные}
\addtext{ живая}
\addtext{ мелкоразмашистый влево}
\addtext{ сглаженность носогубной складки справа}
\addtext{}
\addtext{Нет}
\addtext{Девиация языка влево, сила рук D>S}
\addtext{Не выполняет по тяжести состояния}
\addtext{Непроизвольное мочеиспускание однократное}
\addtext{ отрицательный с обеих сторон}
\addtext{Вес=55кг, Рост=160см, ИМТ=21}
\addtext{сахар крови: 8,4 ммоль/л; SpO2 95\%;  ЭКГ(16.02.21 г. 23:35) ритм синусовый, правильный с ЧСС 95 в мин, ЭОС не отклонена, ST- изолиния, гипертрофия миокарда левого желудочка. ЭКГ для анализа не предоставлено. Данных за острую коронарную патологию нет.}
\addtext{ расспрос;  расспрос родственников;{\par}Установлен в/в катетер в правую кубитальную вену;  Sol.Magnesii sulfatis 250mg/ml-10ml + Sol.Natrii chloridi 0,9\%-250ml в/в капельно со скоростью 60 кап в мин;  Tab. Glicini 500mg сублингвально;{\par}Вызов бригады СМП{\par}{\par}Больная сдана в состоянии средней степени тяжести, АД 150/80 мм.рт.ст., ЧСС 93 в мин, пульс 93 в мин, ЧД 18 в мин, }
\addtext{}
\addtext{ нет}
\addtext{10}
\addtext{1}
