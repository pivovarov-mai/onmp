...
\addtext{на момент осмотра жалуется на легкое головокружениепри перемене положения тела и головную боль, больше в височных областях, постоянного характера, самостоятельно лекарств не принимала. Сердцебиение и перебои в работе сердца, со слов, не беспокоят}
\addtext{Анамнез не дает, агрессивна, со слов " никто ничем не помог, уколов не делали, ритм не восстанавливали",  архив ЭКГ: дважды бригады СМП купировали пароксизм фибрилляции предсердий, амиадароном, эффект урежение ритма, синусовый ритм не восстановлен ( 00:20, 01:30) В анамнезе: пароксизмальная форма фибрилляции предсердий, с частыми срывами сердечного ритма, гипертоническая болезнь. На другие вопросы не отвечает. ЕМИАС, МГФОМС - I48.0, I11.9, I67.8}
\addtext{удовл.}
\addtext{ясное}
\addtext{15}
\addtext{активное}
...
\addtext{нет}
\addtext{нет}
\addtext{ в позе Ромберга устойчива, кординаторные пробы выполнить отказалась}
\addtext{ дизурии нет}
\addtext{ отрицательный с обеих сторон}
\addtext{Вес=88кг, Рост=164см, ИМТ=33, Грубые когнитивно- мнестические нарушения, агрессивна, эмоционально лабильна}
\addtext{SpO2 98 \%;  ЭКГ (17.02.21 г. 05:12) фибрилляция предсердий с ЧЖС 82- 130 в мин, ЭОС - отклонена влево,диффузные изменения  в виде депрессии ST до 1 мм V5-V6, а также отсутствия нарастания з. R в V1-V3, , по сравнению с предыдущей ЭКГ (бригада СМП) - без отрицательной динамики}
\addtext{ расспрос, изучение архива ЭКГ{\par} Sol.Ketaroli 30mg/ml-1ml в/м в правую ягодичную область;  Tab. Glicini 500mg сублингвально{\par}Отказ от вызова бригады СМП, актив в поликлинику{\par}{\par}через 27 мин: состояние удовлетворительное, АД 130/80 мм.рт.ст.,ЧСС 110 в мин, пульс 92 в мин, дифицит пульса 18 в мин, ЧД 16 в мин.}
\addtext{консультация аритмолога в плановом порядке}
\addtext{ нет}
\addtext{6}
\addtext{1}
\addtext{1}
