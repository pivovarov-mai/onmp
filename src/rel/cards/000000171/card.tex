...
\addtext{на недомогание, плохое настроение, небольшое головокружение при перемене положения тела, плохую память. Подобные жалобы беспокоят регулярно более 10 лет. Отмечает ухудшение самочувствия в связи с тревожностью и обеспокоенностью ближайшим будущим. Самостоятельно не лечится. Регистрировала подъем АД до 150/90 мм.рт.ст. который купировала приемом капотена 25 мг около 4 часов назад.}
\addtext{В анамнезе ИБС, гипертоническая болезнь, ХДЭП 2 ст; инсульты, инфаркты отрицает. Менопауза с 50 лет. Травм и операций не было. Аллергию отрицает. Эпиданамнез не отягощен, за пределы Москвы и РФ не выезжала более 10 лет, сезонные прививки отрицает. ЕМИАС, МГФОМС не информативен}
\addtext{удовл.}
\addtext{ясное}
\addtext{15}
\addtext{активное}
...
\addtext{Вес=70кг, Рост=150см, ИМТ=31, Когнитивно- мнестические нарушения, эмоционально лабильна}
\addtext{}
\addtext{ расспрос;{\par} Tab. Glicini 500mg сублингвально;{\par}Оставлен на месте, рекомендовано обратиться в поликлинику{\par}{\par}через 24 мин: состояние удовлетворительное, АД 130/80 мм.рт.ст., ЧСС 76 в мин, пульс 76 в мин, ЧД 16 в мин.}
\addtext{соблюдение режима сна и бодрствования, консультация невролога и психолога в плановом порядке.}
\addtext{ нет}
\addtext{2}
\addtext{1}
\addtext{1}
