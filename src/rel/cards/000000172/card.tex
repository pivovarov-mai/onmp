...
\addtext{на недомогание, головную боль давящего характера в теменных областях, легкое головокружение при перемене положения тела, жалобы беспокоят постоянно более 5 лет. усиливаются после эпизодов подъема АД до 150/90 мм.рт.ст., который купирует приемом капотена 25 мг., а также боль во всем теле, со слов: особенно в грудной клетке, усиливающуюся при поворотах туловища, постоянного характера.}
\addtext{со слов страдает хронической ишемией мозга 2 ст, хр. гастродуоденитом в стадии ремисии, год назад перенесла пневмонию, полиартроз длительно. Травмы, операции отрицает. Эпиданамнез не отягощен, за пределы Москвы и РФ не выезжала более 3 лет, сезонные прививки отрицает. Менопауза с 50 лет. Аллергию отрицает. ЕМИАС. МГФОМС- I67.8,, K29.9, K91.5, M15.8, M42.1}
\addtext{удовл.}
\addtext{ясное}
\addtext{15}
\addtext{активное}
...
\addtext{не выявлены}
\addtext{не выявлены}
\addtext{ пальценосовая проба- выполняет правильно, замедленно; в позе Ромберга- устойчив}
\addtext{ дизурии нет}
\addtext{ отрицательный с обеих сторон}
\addtext{Вес=87кг, Рост=160см, ИМТ=34, Выявляются когнитивно-мнестические нарушения. Визуально грудная клетка искривлена в виде кифосколиоза, умеренное напряжение мышц кора, пальпаторно- паравертебральная болезненность. ВАШ 30 \%  }
\addtext{SpO2 98 \%;  ЭКГ (19.01.21 г. 20:12) ритм синусовый правильный  с ЧСС 69 в мин, ЭОС-отклонена влево. ST- изолиния. ЭКГ признаки гипертрофии миокарда левого желудочка, диффузные изменения миокарда по нижней стенке. ЭКГ для анализа не предоставлено. Данных за острую коронарную патологию нет.}
\addtext{ расспрос.{\par} Tab. Glicini 500mg - сублингвально. Sol.Ketaroli 30mg/ml-1ml в/м в правую ягодичную область{\par}Оставлен на месте, рекомендовано обратиться в поликлинику{\par}{\par}через 31 мин: состояние удовлетворительное, АД 130/80 мм.рт.ст., ЧСС 68 в мин, пульс 68 в мин., ЧД 16 в мин}
\addtext{Соблюдение режима сна и бодрствования, нейропротекторная терапия под наблюдением врача невролога поликлиники}
\addtext{ нет}
\addtext{6}
\addtext{1}
\addtext{1}
