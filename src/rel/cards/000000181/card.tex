...
\addtext{на головную боль, легкое головокружение при перемене положения туловища, жалобы усиливаются при повышении АД, на момент осмотра 180/90 мм.рт.ст., приняла 25 мг капотена, физиотенз 0,2 мг- со слов без эффекта}
\addtext{В анамнезе: ИБС, гипертоническая болезнь (регулярно принимает энап, конкор), пароксизмальная форма фибрилляции предсердий, хроническая ишемия мозга 3 ст, является маломобильным пациентом, после перенесенной травмы- перелом шейки бедра около 5 лет назад. Операции отрицает. Менопауза с 50 лет. Аллергию отрицает. Эпиданамне не отягощен, из Москвы и РФ не выезжала более 10 лет, сезонные прививки отрицает. ЕМИАС, МГФОМС: I11.9, I48.1, I25.1}
\addtext{удовл.}
\addtext{ясное}
\addtext{15}
\addtext{активное}
...
\addtext{Вес=75кг, Рост=163см, ИМТ=28, Выявляются когнитивно-мнестические нарушения}
\addtext{SpO2 98\%;  ЭКГ(19.02.21г. 19:25) ритм синусовый, правильный с ЧСС 62 в мин, ЭОС отклонена резко влево. Диффузные изменения по нижней стенке и перегородочной области в виде подъемов ST до 2 мм. Гипертрофия миокарда левого желудочка. По сравнению с ЭКГ от 04.02.21г. без отрицательной динамики. Данных за острую коронарную патологию нет.}
\addtext{ расспрос, изучение архива ЭКГ.{\par} Tab.Moxonidini 0,4 mg -сублингвально{\par}Оставлен на месте, рекомендовано обратиться в поликлинику{\par}{\par} Через 32 мин: состояние удовлетворительное, АД 150/80 мм.рт.ст., ЧСС 62 в мин, пульс 62 в мин, ЧД 16 в мин.}
