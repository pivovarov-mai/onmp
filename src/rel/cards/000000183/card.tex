...
\addtext{на недомогание, боль в голове, преимущественно в затылочной области, шум в ушах, мушки перед глазами, подъем АД до 190/100 мм.рт.ст., жалобы беспокоят около 2 часов, связывает с эмоциональным перенапряжением, самостоятельно не лечилась. Подобные жалобы возникают периодически, не обследована, регулярную антигипертензивную терапию не принимает}
\addtext{Хронические заболевания, травмы, операции отрицает. Менопауза 2 года. Аллергии нет. Эпиданамнез не отягощен, за пределы Москвы и РФ не выезжала, сезонные прививки отрицает. ЕМИАС, МГФОМС- не доступен}
\addtext{удовл.}
\addtext{ясное}
\addtext{15}
\addtext{активное}
...
\addtext{Вес=80кг, Рост=161см, ИМТ=31}
\addtext{ ЭКГ(19.01.21г.23:04) ритм синусовый, правильный с ЧСС 64 в мин, ЭОС- не отклонена. ST- изолиния.Ггипертрофия миокарда левого желудочка.Данных за острую коронарную патологию нет.}
\addtext{ расспрос,{\par} Tab.Moxonidini 0,4 mg -сублингвально{\par}Оставлен на месте, рекомендовано обратиться в поликлинику{\par}{\par}Через 32 мин: состояние удовлетворительное, АД 145/80 мм.рт.ст., ЧСС 64 в мин, пульс 64 в мин, ЧД 16 в мин}
