...
\addtext{На момент осмотра жалоб не предъявляет.}
\addtext{Состоит на учёте у невролога по поводу ВСД.}
\addtext{удовл.}
\addtext{ясное}
\addtext{}
\addtext{активное}
...
\addtext{отриц}
\addtext{отииц}
\addtext{ в позе Ромберга устойчив пальценосовая проба коленнопяточная проба выполняет правильно}
\addtext{ дизурии нет моча светло-желтая без патологических примесей}
\addtext{ отрицательный с обеих сторон}
\addtext{Вес=60кг, Гипергидроз ладоней и стоп.Красный дермогиафизм}
\addtext{5,7 ммоль/л; SpO2 98\%}
\addtext{{\par}{\par}Оставлен на месте, рекомендовано обратиться в поликлинику{\par}{\par}Во время осмотра почувствовала улучшение самочувствия.  Жалоб нет}
\addtext{}
\addtext{}
\addtext{2}
\addtext{2}
