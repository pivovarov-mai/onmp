...
\addtext{На боль в поясничном отделе позвоночника, без иррадиации, потери чувствительности не отмечает, жалобы беспокоят около 5 часов, связывает с чрезмерными физическими нагрузками (разового характера), однако ухудшение самочувствия около недели, самостоятельно лечился дексалгином,- со слов эффект недостаточный. Вызвал бригаду ОНМП для обезболивания.}
\addtext{В анамнезе:  остеохондроз позвоночника, люмбалгия- несколько раз в год, гипертоническая болезнь. Операций и травм не было. Эпиданамнез не отягощен, за предела Москвы и РФ не выезжал более года, сезонные прививки отрицает. ЕМИАС, МГФОМС не доступен
}
\addtext{удовл.}
\addtext{ясное}
\addtext{15}
...
\addtext{Вес=120кг, Рост=174см, ИМТ=40, Визуально: пояснично-кресцовая область не изменена, умеренное напряжение мышц спины, паравертебральная пальпация- болезненная, симптом Лассега отрицательный с обеих сторон. ВАШ 30\%}
\addtext{}
\addtext{ расспрос;{\par} Sol.Ketaroli 30mg/ml-2 ml в/м в левую ягодичную область;{\par}Оставлен на месте, рекомендовано обратиться в поликлинику{\par}{\par}через 30 мин: состояние удовлетворительное, АД 120/80 мм.рт.ст., ЧСС    в мин, пульс   в мин, ЧД 16 в мин, ВАШ 10\%}
