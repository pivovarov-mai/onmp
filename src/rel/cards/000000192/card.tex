...
\addtext{на ноющую боль в поясн обл}
\addtext{лрлодлл}
\addtext{удовл.}
\addtext{ясное}
\addtext{}
...
\addtext{по ходу левого мочеточника}
\addtext{}
...
\addtext{ дизурии нет}
\addtext{ положительный слева}
\addtext{Вес=70кг}
\addtext{SpO2 99 \%}
\addtext{{\par}{\par}Оставлен на месте, актив в поликлинику{\par}{\par}}
\addtext{}
\addtext{}
\addtext{}
\addtext{}
