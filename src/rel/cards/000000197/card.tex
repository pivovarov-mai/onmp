...
\addtext{На недомогание, подъем температуры до 39,2, заболел остро, болен первый день, связывает с переохлаждением, самостоятельно не лечился, за мед помощью не обращался}
\addtext{Эпид анамнез: ковид 19 перенес в декабре 2020 г., из Москвы не выезжал, сезонные прививки отрицает. В анамнезе: хронический тонзилит. Травмы, операции отрицает, аллергия -ципрофлоксацин (отек Квинке) ЕМИАС, МГФОМС -N45.9}
\addtext{удовл.}
\addtext{ясное}
\addtext{15}
\addtext{активное}
...
\addtext{Вес=78кг, Рост=179см, ИМТ=24, NEWS 1 балла, зев гиперемирован, чистый, миндалины рыхлые, увеличены, ассиметричны, старые гнойные пробки,единичные с обеих сторон, налетлегко снимается, подлежащая ткань не кровоточит. Периферические лимфоузлы увеличены до 0,6 мм, безболезненные при пальпации, не спаяны между собой и окружающей клетчаткой}
\addtext{SpO2 98\%}
\addtext{ расспрос; физические методы охлаждения{\par} Tab.Paracetamoli 500mg внутрь{\par}Отказ от вызова бригады СМП, актив в поликлинику{\par}{\par}Через 45 мин: состояние удовлетворительное, АД 125/80 мм.рт.ст. , ЧСС 80 в мин, пульс 80 в мин, ЧД 16 в мин, температура 37,6,0, NEWS 1 балла}
\addtext{Антибактериальная терапия}
\addtext{ нет}
\addtext{2}
\addtext{1}
\addtext{1}
