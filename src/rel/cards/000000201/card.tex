...
\addtext{На слабость, недомогание, одышку усиливающуюся при незначительной нагрузке,  ухудшение самочувствия отмечает в течении 2 дней, однако больным себя считает в течении недели, с катаральных явлений, самостоятельно лечился: таваник, ацц, амбраксол, ингаверин- без эффекта, за медпомощью обратился 10.03- вызвал терапевта, контакт с ковид 19 отрицает, на самоизоляции, за пределы Москвы не выезжал в течении 2 лет лет, сезонные прививки отрицает}
\addtext{В анамнезе: мочекаменная болезнь, травмы отрицает, оперирован по поводу аппендицита в детстве. Аллергию отрицает.
...
\addtext{}
\addtext{}
\addtext{В верхних отделах с обеих сторон}
\addtext{Влажные}
\addtext{}
\addtext{}
\addtext{нет}
...
\addtext{Вес=81кг, Рост=178см, ИМТ=26, NEWS 0 баллов}
\addtext{SpO2 96\%;  ЭКГ(10.03.21г. 22:41) ритм синусовый. правильный с ЧСС 94 в мин. ЭОС- отклонена влево. Диффузные изменения по перегородочной области в виде подъема ST до 2 мм. Данных за острую коронарную патологию нет}
\addtext{{\par}{\par}Вызов бригады СМП{\par}{\par}Через  43 мин: состояние стабильное, средней степени тяжести, АД 140/90 мм.рт.ст., ЧСС 94 в мин, пульс 94 в мин, сатурация 96\%, NEWS 0 баллов. Бригада отпущена ст. вр. Шарипжановой}
\addtext{}
\addtext{ нет}
\addtext{2}
\addtext{1}
