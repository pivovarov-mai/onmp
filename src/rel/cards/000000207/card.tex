...
\addtext{На момент осмотра жалоб не предъявляет. Со слов сиделки 23.02.21 г. после пробуждения пожаловалась на слабость, недомогание, легкое головокружение, низкое АД 80/60 мм.рт.ст., вызвала СМП, после проведенной терапии самочувствие улучшилось.}
\addtext{В анамнезе ИБС, гипертоническая болезнь ( в течении недели регистрировали плохо коррегируемую гипертензию, на фоне приема базовой терапии, а также использования моксонидина и  капотена), инсульты, инфаркты отрицает. Является маломобильным, инвалидность 1 гр. Менопауза с 50 лет, операции отрицает. Аллергию отрицает. Эпиданамнез не отягощен, за пределы Москвы и РФ не выезжала более 20 лет. ЕМИАС, МГФОМС не доступен}
\addtext{удовл.}
\addtext{ясное}
\addtext{15}
\addtext{активное}
...
\addtext{ мочется в памперс, цвет- светло желтый}
\addtext{ отрицательный с обеих сторон}
\addtext{Вес=98кг, Рост=159см, ИМТ=39}
\addtext{SpO2 98\%}
\addtext{{\par}Отказ от снятия ЭКГ{\par}Отказ от вызова бригады СМП, актив в поликлинику{\par}{\par}через 25 мин: состояние удовлетворительное, АД 120/80 мм.рт.ст., ЧСС 76 в мин, пульс 76 в мин,ЧД 16 в мин}
\addtext{Обилье питье}
\addtext{ нет}
\addtext{2}
\addtext{1}
\addtext{1}
