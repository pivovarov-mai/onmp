...
\addtext{На недомогание, подъем температуры до 38,8, заболела остро, больна первый день, связывает с переохлаждением, самостоятельно лечилась колдрексом, за мед помощью не обращалась}
\addtext{Эпид анамнез: контакт с ковид 19 отрицает, из Москвы не выезжала, сезонные прививки отрицает. В анамнезе: рассеянный склероз, гипертоническая болезнь, травмы, операции отрицает, аллергии нет. Гинекологический анамнез: менолпауза 4 года. ЕМИАС, МГФОМС - G35, I11.8}
\addtext{удовл.}
\addtext{ясное}
\addtext{15}
\addtext{активное}
...
\addtext{Вес=63кг, Рост=168см, ИМТ=22, NEWS 0 баллов, зев гиперемирован, чистый, миндалины рыхлые, регионарные лимфоузлы не увеличены, безболезненные, не спаяны между собой и окружающей клетчаткой}
\addtext{SpO2 98\%}
\addtext{ расспрос, физические методы охлаждения{\par} Tab.Paracetamoli 500mg{\par}Отказ от вызова бригады СМП, актив в поликлинику{\par}{\par}Через 37 мин: состояние удовлетворительное, АД 120/80 мм.рт.ст. , ЧСС 90  в мин, пульс  90в мин, ЧД 16 в мин, температура 37,3, NEWS 0 балла}
