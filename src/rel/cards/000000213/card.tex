...
\addtext{На недомогание, подъем температуры до 38,3, заболел остро, болен первый день, связывает с переохлаждением, а также боль в пояснично кресцовой области, после переноса тяжести, беспокоит около 2 часов, самостоятельно не лечился, за мед помощью не обращался}
\addtext{Эпид анамнез: перенесла ковид 19 в январе 2021г., из Москвы не выезжал, сезонные прививки отрицает. В анамнезе: постоянная форма фибрилляции предсердий более 30 лет, гипертоническая болезнь, нейросенсорная тугоухость,ХДЭП,травмы, операции отрицает, аллергии нет. ЕМИАС, МГФОМС - I11.9}
\addtext{удовл.}
\addtext{ясное}
\addtext{15}
\addtext{активное}
...
\addtext{Вес=90кг, Рост=164см, ИМТ=33, NEWS 0 баллов, зев гиперемирован, чистый, миндалины рыхлые, регионарные лимфоузлы не увеличены, безболезненные, не спаяны между собой и окружающей клетчаткой, гиперлордоз в поясничном отделе, напряжение мышц поясницы, с/м Лассего отрицательный с обеих сторон, ВАШ 20\%}
\addtext{SpO2 99\%}
\addtext{ расспрос{\par}{\par}Отказ от вызова бригады СМП, актив в поликлинику{\par}{\par}Через  28 мин: состояние удовлетворительное, АД 130/80 мм.рт.ст. , ЧСС 90 в мин, пульс 88  в мин, ЧД 16 в мин, температура 37,3, NEWS 0 балла}
\addtext{Полоскание горла, грипферон}
\addtext{ нет}
\addtext{2}
\addtext{1}
\addtext{1}
...
\addtext{1}
\addtext{0}
\addtext{Халат защитный, респиратор ana 1 шт}
\addtext{23.03.21}
\addtext{115718181}
\begin{document}
\relsize{-2}
