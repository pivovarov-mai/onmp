...
\addtext{На повышение АД до 180/90 мм.рт.ст, головную боль, самостоятельно не лечилась, жалобы беспокоят около 2 часов, регулярную антигипертензивную терапию принимает- индопамид 1,5 мг, однако допускает пропуск приема}
\addtext{Из мед документов: гипертоническая болезнь 2 ст, ИБС, болезнь Паркинсона.Травмы- переломы лодыжек- 2010 г., операции отрицает. Аллергию отрицает. Менопауза с 50 лет. ЕМИАС, МГФОМС- не доступен}
\addtext{удовл.}
\addtext{ясное}
\addtext{15}
\addtext{активное}
...
\addtext{Вес=57кг, Рост=162см, ИМТ=22, Когнитивно мнестические нарушения}
\addtext{SpO2 98\%; SpO2 ЭКГ(11.02.21г.11:10) ритм синусовый, правильный с ЧСС 62 в мин, ЭОС отклонена влево. ST- изолиния, гипертрофия миокарда левого желудочка. Данных за острую коронарную патологию нет. По сравнению с ЭКГ от 11.02.21- без отрицательной динамики}
\addtext{ расспрос, изучение архива ЭКГ, {\par} Tab.Moxonidini 0,4 mg -сублингвально{\par}Оставлен на месте, рекомендовано обратиться в поликлинику{\par}{\par}Через 37 мин : состояние удовлетворительное, АД 130/80 мм.рт.ст., ЧСС 60 в мин, пульс 60 в мин, ЧД 16 в мин}
