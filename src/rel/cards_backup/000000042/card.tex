...
\addtext{на боль в грудной клетке колючего характера, возникающую при глубоком вдохе и поворотах туловища, беспокоит несколько дней, связывает с физическими упражнениями и длительной работе за компьютером, самостоятельно не лечилась, за мед помощью не обращалась}
\addtext{в анамнезе: хронический бронхит, в ремисии, остеохондроз позвоночника, другие хронические заболевания, травмы, операции отрицает. Эпиданамнез не отягощен, за пределы Москвы и РФ не выезжал более 2 лет, сезонные прививки отрицает. Аллергии не было. ЕМИАС, МГФОМС- J45.0, N41.1, M42.1}
\addtext{}
\addtext{ясное}
\addtext{15}
\addtext{активное}
...
\addtext{Вес=70кг, Рост=176см, ИМТ=23, визуально грудная клетка не изменена, умеренное напряжение мышц, пальпация межреберного промежутка между 7 и 8 ребрами справа болезненная, ВАШ 30\%}
\addtext{SpO2 99\%; SpO2 ЭКГ(09.01.21г. 17:51) синусовая брадикардия с ЧСС 55 в мин, ЭОС- не отклонена, ST-изолиния. Данных за острую коронарную патологию нет.}
\addtext{ расспрос;{\par} Sol.Ketaroli 30mg/ml-1ml в/м в правую ягодичную область{\par}Оставлен на месте, рекомендовано обратиться в поликлинику{\par}{\par}через 40 мин: состояние удовлетворительное, АД 120/80 мм.рт.ст., ЧСС 58 в мин, пульс 58 в мин, ЧД 16 в мин, t-36,6 ВАШ 10\%}
\addtext{консультация невролога в плановом порядке}
\addtext{ нет}
\addtext{6}
\addtext{1}
\addtext{1}
