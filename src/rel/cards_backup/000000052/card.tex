...
\addtext{На слабость, недомогание, одышку в покое, усиливающуюся при незначительной нагрузке,  ухудшение самочувствия отмечает в течении 2 дней, самостоятельно не лечился, за медпомощью не обращался, контакт с ковид 19 отрицает, на самоизоляции, за пределы Москвы не выезжал в течении 10 лет, сезонные прививки отрицает}
\addtext{В анамнезе ИБС, гипертоническая болезнь,  травмы отрицает, оперирован по поводу катаракты 6 лет назад. Аллергию отрицает.
...
\addtext{}
\addtext{}
\addtext{в нижних отделах справа}
\addtext{Крепитация}
\addtext{}
\addtext{в нижних отделах справа}
\addtext{}
...
\addtext{Вес=68кг, Рост=166см, ИМТ=25, NEWS 5 баллов}
\addtext{SpO2 91\%; SpO2 экг(09.01.21 23:06) ритм синусовый, правильный с ЧСС 77 в мин, ЭОС- не отклонена.ST- изолиния, гипертрофия миокарда левого желудочка.Данных за острую коронарную патологию нет}
\addtext{ расспрос; долгие уговоры{\par}{\par}Отказ от вызова бригады СМП, актив в поликлинику{\par}{\par}Через 40 мин: состояние стабильное, средней степени тяжести, АД 130/80 мм.рт.ст., ЧСС 92 в мин, пульс 92 в мин, сатурация 91\%, NEWS 5 баллов}
