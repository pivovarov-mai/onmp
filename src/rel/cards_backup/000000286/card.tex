...
\addtext{на недомогание, головную боль давящего характера в теменных областях, легкое головокружение при перемене положения тела, жалобы беспокоят постоянно более 5 лет. усиливаются после эпизодов подъема АД до 160/90 мм.рт.ст., который купировала приемом капотена25 мг., }
\addtext{со слов страдает хронической ишемией мозга 2 ст, хр. гастродуоденитом в стадии ремисии, год назад перенесла пневмонию, полиартроз длительно. Травмы, операции отрицает. Эпиданамнез не отягощен, за пределы Москвы и РФ не выезжала более 3 лет, сезонные прививки отрицает. Менопауза с 50 лет. Аллергию отрицает. ЕМИАС. МГФОМС- I67.8, I80.2, I83.9, K29.9, K91.5, M15.8, J18.8}
\addtext{удовл.}
\addtext{ясное}
\addtext{15}
\addtext{активное}
...
\addtext{Вес=87кг, Рост=160см, ИМТ=34, Выявляются когнитивно-мнестические нарушения}
\addtext{}
\addtext{ расспрос.{\par} Tab. Glicini 500mg - сублингвально. Sol.Ketaroli 30mg/ml-1ml в/м в правую ягодичную область{\par}Оставлен на месте, рекомендовано обратиться в поликлинику{\par}{\par}через 29 мин: состояние удовлетворительное, АД 130/80 мм.рт.ст., ЧСС 68 в мин, пульс 68 в мин., ЧД 16 в мин}
\addtext{Соблюдение режима труда и отдыха, нейропротекторная терапия под наблюдением врача невролога поликлиники}
\addtext{ нет}
\addtext{6}
\addtext{1}
\addtext{1}
